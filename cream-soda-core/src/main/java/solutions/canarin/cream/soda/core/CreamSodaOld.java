...
//     */
//    public static CreamSodaOld with(Object... modules) {
//        return new CreamSodaOld(Arrays.asList(modules));
//    }
//
//    /**
//     * Constructs CreamSoda with configuration modules
//     */
//    public static CreamSodaOld with(Iterable<?> modules) {
//        return new CreamSodaOld(modules);
//    }
//
//    private CreamSodaOld(Iterable<?> modules) {
//        providers.put(Key.of(CreamSodaOld.class), new Provider() {
//                    @Override
//                    public Object get() {
//                        return this;
//                    }
